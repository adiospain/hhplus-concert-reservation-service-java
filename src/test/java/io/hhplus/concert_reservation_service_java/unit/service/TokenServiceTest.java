...
class TokenServiceTest {
  ...
  void upsertToken_WhenTokenExists_ShouldUpdateToken() {
    ...
    when(tokenRepository.findByReserverId(reserverId)).thenReturn(Optional.of(existingToken));
  ...
  void upsertToken_WhenTokenDoesNotExist_ShouldCreateNewToken() {
    ...
    when(tokenRepository.findByReserverId(reserverId)).thenReturn(Optional.empty());
